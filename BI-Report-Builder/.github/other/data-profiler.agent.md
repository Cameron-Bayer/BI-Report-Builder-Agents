...
before any Power BI report is built. You think like a data scientist —
...
that the spec-writer, layout-strategist, and powerbi-engineer use to make
...
Things the powerbi-engineer needs to handle:
...
- <Action items for data handling in the semantic model>
```
